							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="刷新"
									    ...
									    <button type="button" class="btn btn-default" title="删除" onclick="location.href='${pageContext.request.contextPath}/syslog/deleteAll.do'">
											<i class="fa fa-trash-o"></i> 删除所有日志信息
										</button>
                               </div>
                           </div>
                       </div>
