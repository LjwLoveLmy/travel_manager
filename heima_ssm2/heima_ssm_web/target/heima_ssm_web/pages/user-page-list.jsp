									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<%--<a href="${pageContext.request.contextPath}/user/findUserById.do?id=${user.id}" class="btn bg-olive btn-xs">编辑</a>--%><%--后期再添加该功能，报错原因userInfo类型转换错误--%>
												<a href="${pageContext.request.contextPath}/user/deleteUser.do?id=${user.id}" class="btn bg-olive btn-xs" onclick="">删除用户</a>
